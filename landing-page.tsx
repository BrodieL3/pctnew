...
import PoliticalCompassTest from "./political-compass-test"

export default function LandingPage() {
  const [startTest, setStartTest] = useState(false)

  if (startTest) {
    return <PoliticalCompassTest />
  }
      ...
      <section className="flex-1 flex flex-col items-center justify-center px-4 py-20 bg-gradient-to-b from-background to-secondary/5">
        <div className="max-w-4xl mx-auto space-y-10 text-center">
          ...
          <div className="flex flex-col items-center space-y-6">
            ...
            <Button size="lg" className="px-8 text-lg h-12 rounded-full" onClick={() => setStartTest(true)}>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <Button size="lg" className="px-8 text-lg h-12 rounded-full mt-8" onClick={() => setStartTest(true)}>
                Start Now
              </Button>
            </div>
