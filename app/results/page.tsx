...
const mockUserPosition = {
  economic: 35, // -100 to 100, negative is left, positive is right
  social: -42, // -100 to 100, negative is libertarian, positive is authoritarian
      ...
      <div className="absolute bottom-4 left-4 z-10 bg-background/80 backdrop-blur-sm p-4 rounded-lg border max-w-xs">
        <div className="space-y-4">
          <div>
            ...
            <p className="text-sm text-muted-foreground">
              Economic: {userPosition.economic} | Social: {userPosition.social}
            </p>
          </div>
